...
<title>Konto Übersicht</title>
    <link rel="stylesheet" type="text/css" id="applicationStylesheet" href="css/Konto__bersicht.css"/>
    <script id="applicationScript" type="text/javascript" src="js/Konto__bersicht.js"></script>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
<body>
	<div id="Konto_bersicht">
		<div id="nach_Kosten_sortieren">
			<span>nach Kosten sortieren</span>
		</div>
		<div id="nach_bot-Bewertung_sortieren">
			<span>nach bot-Bewertung sortieren</span>
		</div>
		<svg class="Pfad_936" viewBox="637.933 5265 14.946 8">
			<path id="Pfad_936" d="M 637.93310546875 5265.00048828125 L 645.111083984375 5273.00048828125 L 652.87890625 5265.00048828125">
			</path>
		</svg>
		<svg class="Pfad_937" viewBox="637.933 5265 14.946 8">
			<path id="Pfad_937" d="M 637.93310546875 5265.00048828125 L 645.111083984375 5273.00048828125 L 652.87890625 5265.00048828125">
			</path>
		</svg>
		<svg class="Pfad_938" viewBox="637.933 5265 14.946 8">
			<path id="Pfad_938" d="M 637.93310546875 5265.00048828125 L 645.111083984375 5273.00048828125 L 652.87890625 5265.00048828125">
			</path>
		</svg>
		<svg class="Pfad_939" viewBox="637.933 5265 14.946 8">
			<path id="Pfad_939" d="M 637.93310546875 5265.00048828125 L 645.111083984375 5273.00048828125 L 652.87890625 5265.00048828125">
			</path>
		</svg>
		<div id="Gruppe_292">
			<img id="Gruppe_248" src="img/Gruppe_248.png" srcset="img/Gruppe_248.png 1x, img/Gruppe_248@2x.png 2x">

			</svg>
			<img id="Gruppe_248_we" src="img/Gruppe_248_we.png" srcset="img/Gruppe_248_we.png 1x, img/Gruppe_248_we@2x.png 2x">

			</svg>
			<img id="Gruppe_248_wf" src="img/Gruppe_248_wf.png" srcset="img/Gruppe_248_wf.png 1x, img/Gruppe_248_wf@2x.png 2x">

			</svg>
			<img id="Gruppe_248_wg" src="img/Gruppe_248_wg.png" srcset="img/Gruppe_248_wg.png 1x, img/Gruppe_248_wg@2x.png 2x">

			</svg>
			<img id="Gruppe_248_wh" src="img/Gruppe_248_wh.png" srcset="img/Gruppe_248_wh.png 1x, img/Gruppe_248_wh@2x.png 2x">

			</svg>
			<div id="KontofhrungsgebhrJahr_xy00_">
				<span>Kontoführungsgebühr/Jahr: xy,00 €</span>
			</div>
			<img id="bank-austria-ag-vector-logo-40" src="img/bank-austria-ag-vector-logo-40.png" srcset="img/bank-austria-ag-vector-logo-40.png 1x, img/bank-austria-ag-vector-logo-40@2x.png 2x">

			<div id="Bank_Austria__Go_Green_Konto_">
				<span>Bank Austria – Go Green Konto </span>
			</div>
			<div id="Stand_7122021">
				<span>Stand: 7.12.2021</span>
			</div>
			<div id="Wiederholungsraster_6">
				<div id="Group_wn" class="">
					<svg class="Pfad_943" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="online_verfgbar">
						<span>online verfügbar</span>
					</div>
				</div>
				<div id="Group_wq" class="">
					<svg class="Pfad_943_wr" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_wr" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="kostenloser_Kontowechselservic">
						<span>kostenloser Kontowechselservice </span>
					</div>
				</div>
			</div>
			<div onclick="application.goToTargetView(event)" id="Button_wt" class="Button">
				<svg class="Rechteck_7_wu">
					<rect id="Rechteck_7_wu" rx="0" ry="0" x="0" y="0" width="135" height="40">
					</rect>
				</svg>
			...
			<svg class="Linie_40_ww" viewBox="0 0 627 1">
				<path id="Linie_40_ww" d="M 0 0 L 627 0">
				</path>
			</svg>
			<svg class="Linie_44" viewBox="0 0 1 25">
				<path id="Linie_44" d="M 0 0 L 0 25">
				</path>
			</svg>
			<div id="Gruppe_251">
				<div id="Gruppe_250">
					<img id="Gruppe_249" src="img/Gruppe_249.png" srcset="img/Gruppe_249.png 1x, img/Gruppe_249@2x.png 2x">

					</svg>
				</div>
			</div>
		</div>
		<svg class="Linie_40_w" viewBox="0 0 627 1">
			<path id="Linie_40_w" d="M 0 0 L 627 0">
			</path>
		</svg>
		<div id="Gruppe_330">
			<img id="Gruppe_248_w" src="img/Gruppe_248_w.png" srcset="img/Gruppe_248_w.png 1x, img/Gruppe_248_w@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xa" src="img/Gruppe_248_xa.png" srcset="img/Gruppe_248_xa.png 1x, img/Gruppe_248_xa@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xb" src="img/Gruppe_248_xb.png" srcset="img/Gruppe_248_xb.png 1x, img/Gruppe_248_xb@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xc" src="img/Gruppe_248_xc.png" srcset="img/Gruppe_248_xc.png 1x, img/Gruppe_248_xc@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xd" src="img/Gruppe_248_xd.png" srcset="img/Gruppe_248_xd.png 1x, img/Gruppe_248_xd@2x.png 2x">

			</svg>
			<div id="KontofhrungsgebhrJahr_xy00__w">
				<span>Kontoführungsgebühr/Jahr: xy,00 €</span>
			</div>
			<img id="umweltcenter-raiffeisenbank-gu" src="img/umweltcenter-raiffeisenbank-gu.png" srcset="img/umweltcenter-raiffeisenbank-gu.png 1x, img/umweltcenter-raiffeisenbank-gu@2x.png 2x">

			<div id="Umweltcenter_Gunskirchen__Umwe">
				<span>Umweltcenter Gunskirchen – Umwelt-Online Sparkonto Flex</span>
			</div>
			<div id="Stand_5122021">
				<span>Stand: 5.12.2021</span>
			</div>
			<div id="Wiederholungsraster_6_xc">
				<div id="Group_xd" class="">
					<svg class="Pfad_943_xe" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_xe" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="online_verfgbar_xf">
						<span>online verfügbar</span>
					</div>
				</div>
				<div id="Group_xg" class="">
					<svg class="Pfad_943_xh" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_xh" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="Kontowechselservice_kostenpfli">
						<span>Kontowechselservice (kostenpflichtig)</span>
					</div>
				</div>
			</div>
			<div onclick="application.goToTargetView(event)" id="Button_xj" class="Button">
				<svg class="Rechteck_7_xk">
					<rect id="Rechteck_7_xk" rx="0" ry="0" x="0" y="0" width="135" height="40">
					</rect>
				</svg>
				<div onclick="application.goToTargetView(event)" id="Produkt-Details_xl">
					<span>Produkt-Details</span>
				</div>
			</div>
			<svg class="Linie_44_xm" viewBox="0 0 1 25">
				<path id="Linie_44_xm" d="M 0 0 L 0 25">
				</path>
			</svg>
			<div id="Gruppe_251_xn">
				<div id="Gruppe_250_xo">
					<img id="Gruppe_249_xp" src="img/Gruppe_249_xp.png" srcset="img/Gruppe_249_xp.png 1x, img/Gruppe_249_xp@2x.png 2x">

					</svg>
				</div>
			</div>
		</div>
		<svg class="Linie_40_xq" viewBox="0 0 627 1">
			<path id="Linie_40_xq" d="M 0 0 L 627 0">
			</path>
		</svg>
		<div id="Gruppe_329">
			<img id="Gruppe_248_xs" src="img/Gruppe_248_xs.png" srcset="img/Gruppe_248_xs.png 1x, img/Gruppe_248_xs@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xt" src="img/Gruppe_248_xt.png" srcset="img/Gruppe_248_xt.png 1x, img/Gruppe_248_xt@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xu" src="img/Gruppe_248_xu.png" srcset="img/Gruppe_248_xu.png 1x, img/Gruppe_248_xu@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xv" src="img/Gruppe_248_xv.png" srcset="img/Gruppe_248_xv.png 1x, img/Gruppe_248_xv@2x.png 2x">

			</svg>
			<img id="Gruppe_248_xw" src="img/Gruppe_248_xw.png" srcset="img/Gruppe_248_xw.png 1x, img/Gruppe_248_xw@2x.png 2x">

			</svg>
			<div id="KontofhrungsgebhrJahr_xy00__xx">
				<span>Kontoführungsgebühr/Jahr: xy,00 €</span>
			</div>
			<img id="index" src="img/index.png" srcset="img/index.png 1x, img/index@2x.png 2x">

			<div id="HYPO_NOE__Konto_grn">
				<span>HYPO NOE – Konto "grün"</span>
			</div>
			<div id="Stand_7122021_x">
				<span>Stand: 7.12.2021</span>
			</div>
			<div id="Wiederholungsraster_6_x">
				<div id="Group_x" class="">
					<svg class="Pfad_943_x" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_x" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="online_verfgbar_x">
						<span>online verfügbar</span>
					</div>
				</div>
				<div id="Group_ya" class="">
					<svg class="Pfad_943_ya" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_ya" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="kostenloser_Kontowechselservic_x">
						<span>kostenloser Kontowechselservice </span>
					</div>
				</div>
			</div>
			<div onclick="application.goToTargetView(event)" id="Button_x" class="Button">
				<svg class="Rechteck_7_x">
					<rect id="Rechteck_7_x" rx="0" ry="0" x="0" y="0" width="135" height="40">
					</rect>
				</svg>
				<div id="Produkt-Details_ya">
					<span>Produkt-Details</span>
				</div>
			</div>
			<svg class="Linie_44_yb" viewBox="0 0 1 25">
				<path id="Linie_44_yb" d="M 0 0 L 0 25">
				</path>
			</svg>
			<div id="Gruppe_251_yc">
				<div id="Gruppe_250_yd">
					<img id="Gruppe_249_ye" src="img/Gruppe_249_ye.png" srcset="img/Gruppe_249_ye.png 1x, img/Gruppe_249_ye@2x.png 2x">

					</svg>
				</div>
			</div>
		</div>
		<svg class="Linie_40_yf" viewBox="0 0 627 1">
			<path id="Linie_40_yf" d="M 0 0 L 627 0">
			</path>
		</svg>
		<div id="Gruppe_328">
			<img id="Gruppe_248_yh" src="img/Gruppe_248_yh.png" srcset="img/Gruppe_248_yh.png 1x, img/Gruppe_248_yh@2x.png 2x">

			</svg>
			<img id="Gruppe_248_yi" src="img/Gruppe_248_yi.png" srcset="img/Gruppe_248_yi.png 1x, img/Gruppe_248_yi@2x.png 2x">

			</svg>
			<img id="Gruppe_248_yj" src="img/Gruppe_248_yj.png" srcset="img/Gruppe_248_yj.png 1x, img/Gruppe_248_yj@2x.png 2x">

			</svg>
			<img id="Gruppe_248_yk" src="img/Gruppe_248_yk.png" srcset="img/Gruppe_248_yk.png 1x, img/Gruppe_248_yk@2x.png 2x">

			</svg>
			<img id="Gruppe_248_yl" src="img/Gruppe_248_yl.png" srcset="img/Gruppe_248_yl.png 1x, img/Gruppe_248_yl@2x.png 2x">

			</svg>
			<div id="KontofhrungsgebhrJahr_xy00__ym">
				<span>Kontoführungsgebühr/Jahr: xy,00 €</span>
			</div>
			<img id="index_yn" src="img/index_yn.png" srcset="img/index_yn.png 1x, img/index_yn@2x.png 2x">

			<div id="HYPO_NOE__Powerkonto_grn">
				<span>HYPO NOE – Powerkonto "grün"</span>
			</div>
			<div id="Stand_7122021_yp">
				<span>Stand: 7.12.2021</span>
			</div>
			<div id="Wiederholungsraster_6_yq">
				<div id="Group_yr" class="">
					<svg class="Pfad_943_ys" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_ys" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="online_verfgbar_yt">
						<span>online verfügbar</span>
					</div>
				</div>
				<div id="Group_yu" class="">
					<svg class="Pfad_943_yv" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_yv" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="kostenloser_Kontowechselservic_yw">
						<span>kostenloser Kontowechselservice </span>
					</div>
				</div>
			</div>
			<div onclick="application.goToTargetView(event)" id="Button_yx" class="Button">
				<svg class="Rechteck_7_yy">
					<rect id="Rechteck_7_yy" rx="0" ry="0" x="0" y="0" width="135" height="40">
					</rect>
				</svg>
				<div id="Produkt-Details_yz">
					<span>Produkt-Details</span>
				</div>
			</div>
			<svg class="Linie_44_y" viewBox="0 0 1 25">
				<path id="Linie_44_y" d="M 0 0 L 0 25">
				</path>
			</svg>
			<div id="Gruppe_251_y">
				<div id="Gruppe_250_y">
					<img id="Gruppe_249_y" src="img/Gruppe_249_y.png" srcset="img/Gruppe_249_y.png 1x, img/Gruppe_249_y@2x.png 2x">

					</svg>
				</div>
			</div>
		</div>
		<svg class="Linie_40_y" viewBox="0 0 627 1">
			<path id="Linie_40_y" d="M 0 0 L 627 0">
			</path>
		</svg>
		<div id="Gruppe_327">
			<img id="Gruppe_248_y" src="img/Gruppe_248_y.png" srcset="img/Gruppe_248_y.png 1x, img/Gruppe_248_y@2x.png 2x">

			</svg>
			<img id="Gruppe_248_za" src="img/Gruppe_248_za.png" srcset="img/Gruppe_248_za.png 1x, img/Gruppe_248_za@2x.png 2x">

			</svg>
			<img id="Gruppe_248_zb" src="img/Gruppe_248_zb.png" srcset="img/Gruppe_248_zb.png 1x, img/Gruppe_248_zb@2x.png 2x">

			</svg>
			<img id="Gruppe_248_zc" src="img/Gruppe_248_zc.png" srcset="img/Gruppe_248_zc.png 1x, img/Gruppe_248_zc@2x.png 2x">

			</svg>
			<img id="Gruppe_248_zd" src="img/Gruppe_248_zd.png" srcset="img/Gruppe_248_zd.png 1x, img/Gruppe_248_zd@2x.png 2x">

			</svg>
			<div id="KontofhrungsgebhrJahr_xy00__zb">
				<span>Kontoführungsgebühr/Jahr: xy,00 €</span>
			</div>
			<img id="Oberbank_Logo" src="img/Oberbank_Logo.png" srcset="img/Oberbank_Logo.png 1x, img/Oberbank_Logo@2x.png 2x">

			<div id="Oberbank__bee_green_Konto">
				<span>Oberbank – be(e) green Konto</span>
			</div>
			<div id="Stand_7122021_ze">
				<span>Stand: 7.12.2021</span>
			</div>
			<div id="Wiederholungsraster_6_zf">
				<div id="Group_zg" class="">
					<svg class="Pfad_943_zh" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_zh" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="online_verfgbar_zi">
						<span>online verfügbar</span>
					</div>
				</div>
				<div id="Group_zj" class="">
					<svg class="Pfad_943_zk" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_zk" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="kostenloser_Kontowechselservic_zl">
						<span>kostenloser Kontowechselservice </span>
					</div>
				</div>
			</div>
			<div onclick="application.goToTargetView(event)" id="Button_zm" class="Button">
				<svg class="Rechteck_7_zn">
					<rect id="Rechteck_7_zn" rx="0" ry="0" x="0" y="0" width="135" height="40">
					</rect>
				</svg>
				<div id="Produkt-Details_zo">
					<span>Produkt-Details</span>
				</div>
			</div>
			<svg class="Linie_44_zp" viewBox="0 0 1 25">
				<path id="Linie_44_zp" d="M 0 0 L 0 25">
				</path>
			</svg>
			<div id="Gruppe_251_zq">
				<div id="Gruppe_250_zr">
					<img id="Gruppe_249_zs" src="img/Gruppe_249_zs.png" srcset="img/Gruppe_249_zs.png 1x, img/Gruppe_249_zs@2x.png 2x">
		...
		<div id="Gruppe_332">
			<div id="Gruppe_326">
				<div id="Stand_7122021_zv">
					<span>Stand: 7.12.2021</span>
				</div>
				<div id="Gruppe_325">
					<img id="Gruppe_299" src="img/Gruppe_299.png" srcset="img/Gruppe_299.png 1x, img/Gruppe_299@2x.png 2x">

					</svg>
					<img id="Gruppe_300" src="img/Gruppe_300.png" srcset="img/Gruppe_300.png 1x, img/Gruppe_300@2x.png 2x">

					</svg>
					<img id="Gruppe_301" src="img/Gruppe_301.png" srcset="img/Gruppe_301.png 1x, img/Gruppe_301@2x.png 2x">

					</svg>
					<img id="Gruppe_302" src="img/Gruppe_302.png" srcset="img/Gruppe_302.png 1x, img/Gruppe_302@2x.png 2x">

					</svg>
					<img id="Gruppe_303" src="img/Gruppe_303.png" srcset="img/Gruppe_303.png 1x, img/Gruppe_303@2x.png 2x">

					</svg>
					<div id="KontofhrungsgebhrJahr_xy00__z">
						<span>Kontoführungsgebühr/Jahr: xy,00 €</span>
					</div>
					<img id="Oberbank_Logo_z" src="img/Oberbank_Logo_z.png" srcset="img/Oberbank_Logo_z.png 1x, img/Oberbank_Logo_z@2x.png 2x">

					<div id="Oberbank__bee_green_Konto_z">
						<span>Oberbank – be(e) green Konto</span>
					</div>
					<div id="Wiederholungsraster_10">
						<div id="Group_z" class="">
							<svg class="Pfad_943_z" viewBox="637.933 5252.46 19.046 13.301">
								<path id="Pfad_943_z" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
								</path>
							</svg>
							<div id="online_verfgbar_z">
								<span>online verfügbar</span>
							</div>
						</div>
						<div id="Group_a" class="">
							<svg class="Pfad_943_a" viewBox="637.933 5252.46 19.046 13.301">
								<path id="Pfad_943_a" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
								</path>
							</svg>
							<div id="kostenloser_Kontowechselservic_b">
								<span>kostenloser Kontowechselservice </span>
							</div>
						</div>
					</div>
					<div onclick="application.goToTargetView(event)" id="Button_d" class="Button">
						<svg class="Rechteck_7_d">
							<rect id="Rechteck_7_d" rx="0" ry="0" x="0" y="0" width="135" height="40">
							</rect>
						</svg>
						<div id="Produkt-Details_e">
							<span>Produkt-Details</span>
						</div>
					</div>
					<svg class="Linie_65" viewBox="0 0 1 25">
						<path id="Linie_65" d="M 0 0 L 0 25">
						</path>
					</svg>
				</div>
			</div>
			<div id="Gruppe_304">
				<div id="Gruppe_250_h">
					<img id="Gruppe_249_i" src="img/Gruppe_249_i.png" srcset="img/Gruppe_249_i.png 1x, img/Gruppe_249_i@2x.png 2x">
		...
		<div id="Gruppe_331">
			<img id="Gruppe_248_k" src="img/Gruppe_248_k.png" srcset="img/Gruppe_248_k.png 1x, img/Gruppe_248_k@2x.png 2x">

			</svg>
			<img id="Gruppe_248_l" src="img/Gruppe_248_l.png" srcset="img/Gruppe_248_l.png 1x, img/Gruppe_248_l@2x.png 2x">

			</svg>
			<img id="Gruppe_248_m" src="img/Gruppe_248_m.png" srcset="img/Gruppe_248_m.png 1x, img/Gruppe_248_m@2x.png 2x">

			</svg>
			<img id="Gruppe_248_n" src="img/Gruppe_248_n.png" srcset="img/Gruppe_248_n.png 1x, img/Gruppe_248_n@2x.png 2x">

			</svg>
			<img id="Gruppe_248_o" src="img/Gruppe_248_o.png" srcset="img/Gruppe_248_o.png 1x, img/Gruppe_248_o@2x.png 2x">

			</svg>
			<div id="KontofhrungsgebhrJahr_xy00__p">
				<span>Kontoführungsgebühr/Jahr: xy,00 €</span>
			</div>
			<img id="bank-austria-ag-vector-logo-40_q" src="img/bank-austria-ag-vector-logo-40_q.png" srcset="img/bank-austria-ag-vector-logo-40_q.png 1x, img/bank-austria-ag-vector-logo-40_q@2x.png 2x">

			<div id="Bank_Austria__Go_Green_Konto__r">
				<span>Bank Austria – Go Green Konto </span>
			</div>
			<div id="Stand_7122021_s">
				<span>Stand: 7.12.2021</span>
			</div>
			<div id="Wiederholungsraster_6_t">
				<div id="Group_u" class="">
					<svg class="Pfad_943_v" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_v" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="online_verfgbar_w">
						<span>online verfügbar</span>
					</div>
				</div>
				<div id="Group_y" class="">
					<svg class="Pfad_943_y" viewBox="637.933 5252.46 19.046 13.301">
						<path id="Pfad_943_y" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
						</path>
					</svg>
					<div id="kostenloser_Kontowechselservic_z">
						<span>kostenloser Kontowechselservice </span>
					</div>
				</div>
			</div>
			<div onclick="application.goToTargetView(event)" id="Button_" class="Button">
				<svg class="Rechteck_7_">
					<rect id="Rechteck_7_" rx="0" ry="0" x="0" y="0" width="135" height="40">
					</rect>
				</svg>
				<div id="Produkt-Details_">
					<span>Produkt-Details</span>
				</div>
			</div>
			<svg class="Linie_40_" viewBox="0 0 627 1">
				<path id="Linie_40_" d="M 0 0 L 627 0">
				</path>
			</svg>
			<svg class="Linie_44_" viewBox="0 0 1 25">
				<path id="Linie_44_" d="M 0 0 L 0 25">
				</path>
			</svg>
			<div id="Gruppe_251_">
				<div id="Gruppe_250_">
					<img id="Gruppe_249_" src="img/Gruppe_249_.png" srcset="img/Gruppe_249_.png 1x, img/Gruppe_249_@2x.png 2x">
		...
		<!--<div id="Gruppe_305_">
		<div id="Musteransicht_">
			<span>Musteransicht</span>
		</div>
		<div id="Musteransicht_a">
			<span>Musteransicht</span>
		</div>
		<div id="Musteransicht_b">
			<span>Musteransicht</span>
		</div>
		<div id="Musteransicht_c">
			<span>Musteransicht</span>
		</div>
		<div id="Musteransicht_d">
			<span>Musteransicht</span>
		</div>
		<div id="Musteransicht_e">
			<span>Musteransicht</span>
		</div>
	</div-->
		<div id="Gruppe_291">
			<div id="Gruppe_253">
				<img id="iStock-181098668" src="img/iStock-181098668.png" srcset="img/iStock-181098668.png 1x, img/iStock-181098668@2x.png 2x">

				<div onclick="application.goToTargetView(event)" id="Button_i">
					<svg class="Rechteck_7_j">
						<rect id="Rechteck_7_j" rx="0" ry="0" x="0" y="0" width="279" height="54">
						</rect>
					</svg>
					<div id="Jetzt_kostenlos_registrieren_k">
						<span>Jetzt kostenlos registrieren</span>
					</div>
				</div>
				<div id="Dann_registriere_dich_jetzt_gl">
					<span>Dann registriere dich jetzt gleich, um alle Informationen & News rund um grüne Finanz- & Veranlagungsprodukte zu erhalten.</span>
				</div>
			</div>
			<div id="Willst_du_mehr_Informationen">
				<span>Willst du mehr Informationen?</span>
			</div>
		</div>
		<img id="iStock-854130132" src="img/iStock-854130132.png" srcset="img/iStock-854130132.png 1x, img/iStock-854130132@2x.png 2x">

		<div id="Ein_Konto_also_eigentlich_ein_">
			<span>Ein Konto, also eigentlich ein </span><span style="color:rgba(3,49,108,1);">Girokonto</span><span>, benötigst du für Überweisungen die du erhältst sowie für Zahlungen, die du tätigst. Mit dem Kontoguthaben werden ausnahmslos nachhaltige Projekte finanziert.<br /><br />Hier findest du nachhaltige Girokonten, die du in Österreich online eröffnen kannst. Alle beschriebenen Girokonten sind mit dem </span><span style="color:rgba(3,49,108,1);">Österreichischen Umweltzeichen für nachhaltige Finanzprodukte </span><span>(UZ49) ausgezeichnet.</span>
		</div>
		<div id="bersicht_nachhaltiger_Privatko">
			<span>Übersicht nachhaltiger Privatkonten </span>
		</div>
		<div id="yourmoneymatters_q">
			<span>#yourmoneymatters</span>
		</div>
		<div id="Home______Konto______Privatkon">
			<span>Home      Konto      Privatkonto      Übersicht nachhaltiger Privatkonten</span>
		</div>
		<svg class="Rechteck_23_s">
			<rect id="Rechteck_23_s" rx="0" ry="0" x="0" y="0" width="811" height="796">
			</rect>
		</svg>
		<div id="Wonach_suchst_du">
			<span>Wonach suchst du?</span>
		</div>
		<div id="Gruppe_286">
			<div id="Bevorzugtes_Bankinstitut">
				<span>Bevorzugtes Bankinstitut</span>
			</div>
		</div>
		<div id="Gruppe_285">
			<div id="Erweiterte_Suche">
				<span>Erweiterte Suche</span>
			</div>
			<div id="Button_y" class="Button">
				<svg class="Rechteck_7_z">
					<rect id="Rechteck_7_z" rx="0" ry="0" x="0" y="0" width="121" height="40">
					</rect>
				</svg>
				<div id="Jetzt_suchen">
			...
			<div class="g_selects">
				<div class="dropdown_g1">
					<select class="s1">
						<option disabled selected>Kontoart</option>
						<option>Option 1</option>
						<option>Option 2</option>
					</select>
				</div>

				<div class="dropdown_g2">
					<select class="s1">
				...
				<div class="dropdown_g4">
					<select class="s1">
						<option disabled selected>Filter 4</option>
						<option>Option 1</option>
						<option>Option 2</option>
					</select>
				</div>
			...
			<!--div id="Wiederholungsraster_4">
				...
				<div id="Gruppe_197_" class="Gruppe_197">
					<svg class="Rechteck_24_">
						<rect id="Rechteck_24_" rx="0" ry="0" x="0" y="0" width="460" height="40">
						</rect>
					</svg>
					<div id="Kontoart">
						<span>Kontoart</span>
					</div>
					<svg class="Pfad_900_" viewBox="637.933 5265 23.2 12.418">
						<path id="Pfad_900_" d="M 637.93310546875 5265.00048828125 L 649.0750732421875 5277.41845703125 L 661.1326904296875 5265.00048828125">
						</path>
					</svg>
				</div>
				<div id="Gruppe_197_a" class="Gruppe_197">
					<svg class="Rechteck_24_a">
						<rect id="Rechteck_24_a" rx="0" ry="0" x="0" y="0" width="460" height="40">
						</rect>
					</svg>
					<div id="Land">
						<span>Land</span>
					</div>
					<svg class="Pfad_900_a" viewBox="637.933 5265 23.2 12.418">
						<path id="Pfad_900_a" d="M 637.93310546875 5265.00048828125 L 649.0750732421875 5277.41845703125 L 661.1326904296875 5265.00048828125">
						</path>
					</svg>
				</div>
				<div id="Gruppe_197_b" class="Gruppe_197">
					<svg class="Rechteck_24_b">
						<rect id="Rechteck_24_b" rx="0" ry="0" x="0" y="0" width="460" height="40">
						</rect>
					</svg>
					<div id="Filter_3">
						<span>Filter 3</span>
					</div>
					<svg class="Pfad_900_d" viewBox="637.933 5265 23.2 12.418">
						<path id="Pfad_900_d" d="M 637.93310546875 5265.00048828125 L 649.0750732421875 5277.41845703125 L 661.1326904296875 5265.00048828125">
						</path>
					</svg>
				</div>
				<div id="Gruppe_197_e" class="Gruppe_197">
					<svg class="Rechteck_24_f">
						<rect id="Rechteck_24_f" rx="0" ry="0" x="0" y="0" width="460" height="40">
						</rect>
					</svg>
					<div id="Filter_4">
						<span>Filter 4</span>
					</div>
					<svg class="Pfad_900_i" viewBox="637.933 5265 23.2 12.418">
						<path id="Pfad_900_i" d="M 637.93310546875 5265.00048828125 L 649.0750732421875 5277.41845703125 L 661.1326904296875 5265.00048828125">
						</path>
					</svg>
				</div>
			</div-->
		</div>
		<img id="Umweltzeichen_i" src="img/Umweltzeichen_i.png" srcset="img/Umweltzeichen_i.png 1x, img/Umweltzeichen_i@2x.png 2x">

		<div id="Gruppe_252">
			<div id="Was_ist_ein_grnes_Konto__Koste">
				<span>Was ist ein grünes Konto? <br />Kostet mich der Kontowechsel etwas?<br />Wie verdient birds of trust Geld?<br />Was passiert mit meinen Daten?</span>
			</div>
			<div id="Hufige_Fragen">
				<span>Häufige Fragen</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Button_m" class="Button">
				<svg class="Rechteck_7_n">
					<rect id="Rechteck_7_n" rx="0" ry="0" x="0" y="0" width="114" height="40">
					</rect>
				</svg>
				<div id="Zu_den_FAQ">
		...
		<div id="Blog_-_Teaser" class="Blog___Teaser">
			<svg class="Rechteck_49_q">
				<rect id="Rechteck_49_q" rx="0" ry="0" x="0" y="0" width="298" height="199">
				</rect>
			</svg>
			<svg class="fh-wien50_r">
				<rect id="fh-wien50_r" rx="0" ry="0" x="0" y="0" width="298" height="190">
				</rect>
			</svg>
			<svg class="Rechteck_58">
				<rect id="Rechteck_58" rx="0" ry="0" x="0" y="0" width="298" height="199">
				</rect>
			</svg>
			<svg class="Rechteck_59">
				<rect id="Rechteck_59" rx="0" ry="0" x="0" y="0" width="298" height="385">
				</rect>
			</svg>
			<svg class="Rechteck_45_u">
				<rect id="Rechteck_45_u" rx="0" ry="0" x="0" y="0" width="298" height="199">
				</rect>
			</svg>
			<img id="iStock-1349465204_v" src="img/iStock-1349465204_v.png" srcset="img/iStock-1349465204_v.png 1x, img/iStock-1349465204_v@2x.png 2x">

			<img id="iStock-1367145986_w" src="img/iStock-1367145986_w.png" srcset="img/iStock-1367145986_w.png 1x, img/iStock-1367145986_w@2x.png 2x">

			<img id="iStock-1303397527_x" src="img/iStock-1303397527_x.png" srcset="img/iStock-1303397527_x.png 1x, img/iStock-1303397527_x@2x.png 2x">

			<img id="iStock-1257563298_y" src="img/iStock-1257563298_y.png" srcset="img/iStock-1257563298_y.png 1x, img/iStock-1257563298_y@2x.png 2x">

			<div id="Greenwashing__ein_Kind_unserer_z">
				<span>Greenwashing – ein Kind unserer Zeit oder nur miese Geschäftemacherei?</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Jetzt_reinlesen_">
				<span>Jetzt reinlesen</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Jetzt_anmelden_">
				<span>Jetzt anmelden</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Jetzt_vergleichen_">
				<span>Jetzt vergleichen</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Jetzt_reinlesen_a">
				<span>Jetzt reinlesen</span>
			</div>
			<div id="Wie_dein_Geld_zur__Klima-Abkhl">
				<span>Wie dein Geld zur <br />Klima-Abkühlung beitragen kann.</span>
			</div>
			<div id="Wie_nachhaltig_sind_Bitcoin__C_">
				<span>Wie nachhaltig sind Bitcoin & Co?</span>
			</div>
			<div id="Fast_Fashion__ein_ungesunder_T_">
				<span>Fast Fashion – ein ungesunder Trend </span>
			</div>
			<div id="n_3_Mai_2022_">
				<span>13. Mai 2022</span>
			</div>
			<div id="n__Mai_2022_">
				<span>5. Mai 2022</span>
			</div>
			<div id="n_5_April_2022">
				<span>15. April 2022</span>
			</div>
			<div id="n__April_2022">
				<span>2. April 2022</span>
			</div>
			<div id="Das_knnte_dich_auch_noch_inter">
				<span>Das könnte dich auch noch interessieren:</span>
			</div>
		</div>
		<div id="Gruppe_333">
			<div id="n___2__3">
			...
			<div id="Pfeil_e" class="Pfeil">
				<div id="Ebene_1_f">
					<div id="Gruppe_139_g">
						<svg class="Linie_14_h" viewBox="0 0 3 28.333">
							<path id="Linie_14_h" d="M 0 0 L 0 28.3333797454834">
							</path>
						</svg>
						<svg class="Pfad_134_i" viewBox="1.061 2.121 23.333 11.667">
							<path id="Pfad_134_i" d="M 1.060660004615784 13.78800010681152 L 12.72729969024658 2.121320009231567 L 24.39399909973145 13.78800010681152">
							</path>
						</svg>
					</div>
				</div>
			</div>
			<div id="Pfeil_j" class="Pfeil">
				<div id="Ebene_1_l">
					<div id="Gruppe_139_l">
						<svg class="Linie_14_m" viewBox="0 0 3 28.333">
							<path id="Linie_14_m" d="M 0 0 L 0 28.3333797454834">
							</path>
						</svg>
						<svg class="Pfad_134_n" viewBox="1.061 2.121 23.333 11.667">
							<path id="Pfad_134_n" d="M 1.060660004615784 13.78800010681152 L 12.72729969024658 2.121320009231567 L 24.39399909973145 13.78800010681152">
							</path>
						</svg>
					</div>
				</div>
		...
		<svg class="Pfad_945" viewBox="637.933 5265 11.209 6">
			<path id="Pfad_945" d="M 637.93310546875 5265.00048828125 L 643.3165893554688 5271.00048828125 L 649.1424560546875 5265.00048828125">
			</path>
		</svg>
		<svg class="Pfad_946" viewBox="637.933 5265 11.209 6">
			<path id="Pfad_946" d="M 637.93310546875 5265.00048828125 L 643.3165893554688 5271.00048828125 L 649.1424560546875 5265.00048828125">
			</path>
		</svg>
		<svg class="Pfad_947" viewBox="637.933 5265 11.209 6">
			<path id="Pfad_947" d="M 637.93310546875 5265.00048828125 L 643.3165893554688 5271.00048828125 L 649.1424560546875 5265.00048828125">
			</path>
		</svg>
		<div id="Footer_r" class="Footer">
			<div onclick="application.goToTargetView(event)" id="AGB_s">
				<span>AGB</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Datenschutz_t">
				<span>Datenschutz</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Newsletteranmeldung_u">
				<span>Newsletteranmeldung</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Impressum_v">
				<span>Impressum</span>
			</div>
			<div id="Alle_Texte_sowie_die_Hinweise__w">
				<span>Alle Texte sowie die Hinweise und Informationen stellen keine Anlagenberatung oder Empfehlung dar. Sie wurden nach betem Wissen und Gewissen aus öffentlich zugänglichen Quellen übernommen. Alle zur Verfügung gestellten Informationen (alle Gedanken, Prognosen, Kommentare, Hinweise, Ratschläge etc.) dienen allein der Bildung und der privaten Unterhaltung.</span>
			</div>
			<div id="E__infobirdsoftrustat_x">
				<span>E</span><span style="font-style:normal;font-weight:normal;">  info@birdsoftrust.at</span>
			</div>
			<div id="T__43_660_2004_512_y">
				<span>T</span><span style="font-style:normal;font-weight:normal;">  +43 660 2004 512</span>
			</div>
			<div id="Gruppe_209_z">
				<div id="Gruppe_166_">
					<img id="Gruppe_165_" src="img/Gruppe_165_.png" srcset="img/Gruppe_165_.png 1x, img/Gruppe_165_@2x.png 2x">
				...
				<div id="Gruppe_157_">
					<img id="Gruppe_156_a" src="img/Gruppe_156_a.png" srcset="img/Gruppe_156_a.png 1x, img/Gruppe_156_a@2x.png 2x">
		...
		<div id="Follow_Us_-_Blog_v" class="Follow_Us___Blog">
				...
				<div id="Gruppe_216_z">
					...
					<div id="Gruppe_214_">
						<div id="Gruppe_213_">
							...
							<img id="Bild_1_" src="img/Bild_1_.png" srcset="img/Bild_1_.png 1x, img/Bild_1_@2x.png 2x">

							<img id="Bild_2_" src="img/Bild_2_.png" srcset="img/Bild_2_.png 1x, img/Bild_2_@2x.png 2x">

							<svg class="Rechteck_44_">
								<rect id="Rechteck_44_" rx="0" ry="0" x="0" y="0" width="22" height="23">
								</rect>
							</svg>
							<div id="n_0_a">
								<span>40</span>
			...
			<div id="Gruppe_316_f">
				<svg class="Rechteck_45_g">
					<rect id="Rechteck_45_g" rx="0" ry="0" x="0" y="0" width="298" height="290">
					</rect>
				</svg>
				<img id="Bild1_h" src="img/Bild1_h.png" srcset="img/Bild1_h.png 1x, img/Bild1_h@2x.png 2x">

				<div id="Gruppe_216_i">
					<div id="birdsoftrust_3_April_j">
					...
					<div id="Gruppe_214_k">
						<div id="Gruppe_213_l">
							...
							<img id="Bild_1_n" src="img/Bild_1_n.png" srcset="img/Bild_1_n.png 1x, img/Bild_1_n@2x.png 2x">

							<img id="Bild_2_o" src="img/Bild_2_o.png" srcset="img/Bild_2_o.png 1x, img/Bild_2_o@2x.png 2x">

							<svg class="Rechteck_44_p">
								<rect id="Rechteck_44_p" rx="0" ry="0" x="0" y="0" width="22" height="23">
								</rect>
							</svg>
							<div id="n_5_q">
								<span>25</span>
					...
					<div id="Gruppe_215_r">
						<svg class="Ellipse_12_s">
							<ellipse id="Ellipse_12_s" rx="26.127899169921875" ry="26.127899169921875" cx="26.127899169921875" cy="26.127899169921875">
							</ellipse>
						</svg>
						<div id="Ebene_2_t">
							<div id="Ebene_1_u">
								<div id="Gruppe_113_v">
									<svg class="Pfad_113_w" viewBox="144.891 0 52.817 12.542">
										<path id="Pfad_113_w" d="M 168.2411804199219 12.54227447509766 C 167.8211364746094 12.54227447509766 167.4266357421875 12.3341703414917 167.15771484375 11.95836162567139 C 166.6829376220703 11.29495048522949 166.7095184326172 10.318115234375 167.2308959960938 9.343507766723633 C 167.6418609619141 8.567933082580566 168.2290496826172 7.772597789764404 168.970703125 6.988410949707031 C 168.8742065429688 6.814169883728027 168.7678527832031 6.639458656311035 168.6504058837891 6.465274810791016 C 167.0174713134766 4.040791511535645 163.7938079833984 2.341738939285278 160.2377166748047 2.030543327331543 C 152.6326141357422 1.368636965751648 145.2698059082031 6.241406917572021 145.1968231201172 6.28901195526123 L 144.8907470703125 5.835519790649414 C 144.9672241210938 5.785888195037842 152.4799346923828 0.7994511127471924 160.2858581542969 1.48614513874054 C 164.0022125244141 1.811497688293457 167.3803100585938 3.601196527481079 169.1038818359375 6.161131858825684 C 169.1983337402344 6.300160884857178 169.28515625 6.440433979034424 169.3674774169922 6.5827317237854 C 172.5817108154297 3.421666145324707 178.2508239746094 0.5325412154197693 184.9274597167969 0.06489218026399612 C 196.3937683105469 -0.7304430603981018 197.6927490234375 6.050986766815186 197.7074279785156 6.120112419128418 L 197.1681365966797 6.212573051452637 C 197.1220245361328 5.953028678894043 195.9157104492188 -0.1630210280418396 184.9649200439453 0.6107933521270752 C 178.3308563232422 1.074916005134583 172.7280731201172 3.96051025390625 169.6323394775391 7.082324504852295 C 170.2266082763672 8.333178520202637 170.3578186035156 9.619498252868652 169.9987487792969 10.79183387756348 C 169.6964416503906 11.78214931488037 169.1307525634766 12.41393089294434 168.4493560791016 12.52584171295166 C 168.3797149658203 12.53849315643311 168.3085784912109 12.54227924346924 168.2411804199219 12.54227924346924 L 168.2411804199219 12.54227924346924 Z M 169.2264404296875 7.509474277496338 C 168.5878448486328 8.208353996276855 168.0776214599609 8.913043022155762 167.7110137939453 9.599990844726562 C 167.2914276123047 10.38796710968018 167.25244140625 11.15062999725342 167.600830078125 11.64011383056641 C 167.7945404052734 11.90873432159424 168.0738372802734 12.03334903717041 168.3622283935547 11.98698139190674 C 168.828369140625 11.91075134277344 169.2355499267578 11.41598606109619 169.4776000976562 10.63133430480957 C 169.7784271240234 9.65340518951416 169.6857757568359 8.573217391967773 169.2264251708984 7.509475708007812 L 169.2264251708984 7.509475708007812 Z">
										</path>
									</svg>
								</div>
							</div>
				...
				<div id="Lorem_ipsum_dolor_sit_amet_con_x">
					<span>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</span>
				</div>
			</div>
			<div id="birdsoftrust_y">
				<span>@birdsoftrust</span>
			</div>
			<div id="Jetzt_birds_of_trust_auf_Insta_z">
				<span>Jetzt birds of trust auf Instagram folgen</span>
			</div>
			<div id="Follow_Us_">
				<span>Follow Us</span>
			</div>
			<div id="Du_willst_noch__mehr_wissen_">
				<span>Du willst noch <br />mehr wissen?</span>
			</div>
			<div id="Dann_werde_Teil_unserer_birds__">
			...
			<div id="Gruppe_233_">
				<div id="Gruppe_166_a">
					<img id="Gruppe_165_a" src="img/Gruppe_165_a.png" srcset="img/Gruppe_165_a.png 1x, img/Gruppe_165_a@2x.png 2x">

					</svg>
				</div>
				<div id="Gruppe_157_a">
					<img id="Gruppe_156_" src="img/Gruppe_156_.png" srcset="img/Gruppe_156_.png 1x, img/Gruppe_156_@2x.png 2x">

					</svg>
				</div>
				<div id="Gruppe_160_">
					<img id="Gruppe_159_" src="img/Gruppe_159_.png" srcset="img/Gruppe_159_.png 1x, img/Gruppe_159_@2x.png 2x">

					</svg>
				</div>
			</div>
		</div>
		<!--div id="Dropdown_a" class="Dropdown">
			<div id="Gruppe_312_b">
				<svg class="Rechteck_24_c">
					<rect id="Rechteck_24_c" rx="0" ry="0" x="0" y="0" width="460" height="40">
					</rect>
				</svg>
				<div id="Bank_d">
					<span>Bank</span>
				</div>
				<svg class="Pfad_900_e" viewBox="637.933 5265 23.2 12.418">
					<path id="Pfad_900_e" d="M 637.93310546875 5265.00048828125 L 649.0750732421875 5277.41845703125 L 661.1326904296875 5265.00048828125">
					</path>
				</svg>
			</div>
		</!--div>
		<div id="Dropdown_f" class="Dropdown">
			<div id="Gruppe_312_g">
				<svg class="Rechteck_24_i">
					<rect id="Rechteck_24_i" rx="0" ry="0" x="0" y="0" width="460" height="40">
					</rect>
				</svg>
				<div id="Nachhaltiges_Privatkonto">
					<span>Nachhaltiges Privatkonto</span>
				</div>
				<svg class="Pfad_900_j" viewBox="637.933 5265 23.2 12.418">
					<path id="Pfad_900_j" d="M 637.93310546875 5265.00048828125 L 649.0750732421875 5277.41845703125 L 661.1326904296875 5265.00048828125">
					</path>
				</svg>
			</div>
		</div-->
		<div class="dropdown">
			<select class="s1">
				<option disabled selected>Nachhaltiges Privatkonto</option>
				<option>Option 1</option>
				<option>Option 2</option>
			</select>
		</div>
		...
		<div id="Kontaktflappe_k" class="Kontaktflappe">
			<svg class="Rechteck_20_l">
				<rect id="Rechteck_20_l" rx="0" ry="0" x="0" y="0" width="55" height="223">
				</rect>
			</svg>
			<div id="Gruppe_166_m">
				<img id="Gruppe_165_n" src="img/Gruppe_165_n.png" srcset="img/Gruppe_165_n.png 1x, img/Gruppe_165_n@2x.png 2x">
			...
			<div id="Gruppe_157_v">
				<img id="Gruppe_156_w" src="img/Gruppe_156_w.png" srcset="img/Gruppe_156_w.png 1x, img/Gruppe_156_w@2x.png 2x">

				</svg>
			</div>
			<img id="Gruppe_159_x" src="img/Gruppe_159_x.png" srcset="img/Gruppe_159_x.png 1x, img/Gruppe_159_x@2x.png 2x">

			</svg>
		</div>
		<div id="Men_y" class="Men_">
			<svg class="Rechteck_73_z">
				<rect id="Rechteck_73_z" rx="0" ry="0" x="0" y="0" width="1920" height="68">
				</rect>
			</svg>
			<div id="Men_">
				<svg class="Pfad_904_" viewBox="0 0 1920 50">
					<path id="Pfad_904_" d="M 0 0 L 1920 0 L 1920 50 L 0 50 L 0 0 Z">
					</path>
				</svg>
				...
				<div id="Ebene_2_i">
					<div id="Ebene_1_j">
						<div id="Gruppe_118_k">
							<svg class="Pfad_143_l" viewBox="18.839 18.809 9.256 9.256">
								<path id="Pfad_143_l" d="M 18.83860015869141 21.83567047119141 L 24.44058799743652 27.43770980834961 C 25.27626800537109 28.27423477172852 26.63207244873047 28.27423477172852 27.46650123596191 27.43770980834961 C 28.30387687683105 26.60331726074219 28.30387687683105 25.24673080444336 27.46650123596191 24.41273880004883 L 21.86441612243652 18.80940246582031">
								</path>
							</svg>
							<svg class="Pfad_144_m" viewBox="0.893 0.893 20.477 20.477">
								<path id="Pfad_144_m" d="M 21.3698616027832 11.1312894821167 C 21.3698616027832 16.78590965270996 16.78593635559082 21.3698616027832 11.13128852844238 21.3698616027832 C 5.476641654968262 21.3698616027832 0.8928599953651428 16.78590965270996 0.8928599953651428 11.1312894821167 C 0.8928599953651428 5.476668834686279 5.476829528808594 0.8928599953651428 11.1312894821167 0.8928599953651428 C 16.7857494354248 0.8928599953651428 21.3698616027832 5.47663402557373 21.3698616027832 11.13125514984131 Z">
								</path>
							</svg>
						</div>
					</div>
