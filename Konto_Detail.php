...
<title>Konto Detail</title>
<link rel="stylesheet" href="css/Konto_Detail.css" id="applicationStylesheet"/>
<script src="js/Konto_Detail.js" id="applicationScript"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
</head>
<body>
    <div id="Konto_Detail">
        <div id="Blog_-_Teaser_" class="Blog___Teaser">
            <svg class="Rechteck_49_">
                <rect id="Rechteck_49_" rx="0" ry="0" x="0" y="0" width="298" height="199">
                </rect>
            </svg>
            <svg class="fh-wien50_">
                <rect id="fh-wien50_" rx="0" ry="0" x="0" y="0" width="298" height="190">
                </rect>
            </svg>
            <svg class="Rechteck_58_">
                <rect id="Rechteck_58_" rx="0" ry="0" x="0" y="0" width="298" height="199">
                </rect>
            </svg>
            <svg class="Rechteck_59_a">
                <rect id="Rechteck_59_a" rx="0" ry="0" x="0" y="0" width="298" height="385">
                </rect>
            </svg>
            <svg class="Rechteck_45_b">
                <rect id="Rechteck_45_b" rx="0" ry="0" x="0" y="0" width="298" height="199">
                </rect>
            </svg>
            <img id="iStock-1349465204_c" src="img/iStock-1349465204_c.png" srcset="img/iStock-1349465204_c.png 1x, img/iStock-1349465204_c@2x.png 2x">

            <img id="iStock-1367145986_d" src="img/iStock-1367145986_d.png" srcset="img/iStock-1367145986_d.png 1x, img/iStock-1367145986_d@2x.png 2x">

            <img id="iStock-1303397527_e" src="img/iStock-1303397527_e.png" srcset="img/iStock-1303397527_e.png 1x, img/iStock-1303397527_e@2x.png 2x">

            <img id="iStock-1257563298_f" src="img/iStock-1257563298_f.png" srcset="img/iStock-1257563298_f.png 1x, img/iStock-1257563298_f@2x.png 2x">

            <div id="Greenwashing__ein_Kind_unserer_g">
                <span>Greenwashing – ein Kind unserer Zeit oder nur miese Geschäftemacherei?</span>
            </div>
            <div onclick="application.goToTargetView(event)" id="Jetzt_reinlesen_h">
                <span>Jetzt reinlesen</span>
            </div>
            <div onclick="application.goToTargetView(event)" id="Jetzt_anmelden_i">
                <span>Jetzt anmelden</span>
            </div>
            <div onclick="application.goToTargetView(event)" id="Jetzt_vergleichen_j">
                <span>Jetzt vergleichen</span>
            </div>
            <div onclick="application.goToTargetView(event)" id="Jetzt_reinlesen_k">
                <span>Jetzt reinlesen</span>
            </div>
            <div id="Wie_dein_Geld_zur__Klima-Abkhl_l">
                <span>Wie dein Geld zur <br />Klima-Abkühlung beitragen kann.</span>
            </div>
            <div id="Wie_nachhaltig_sind_Bitcoin__C_m">
                <span>Wie nachhaltig sind Bitcoin & Co?</span>
            </div>
            <div id="Fast_Fashion__ein_ungesunder_T_n">
                <span>Fast Fashion – ein ungesunder Trend </span>
            </div>
            <div id="n_3_Mai_2022_o">
                <span>13. Mai 2022</span>
            </div>
            <div id="n__Mai_2022_p">
                <span>5. Mai 2022</span>
            </div>
            <div id="n_5_April_2022_q">
                <span>15. April 2022</span>
            </div>
            <div id="n__April_2022_r">
                <span>2. April 2022</span>
            </div>
            <div id="Das_knnte_dich_auch_noch_inter_s">
                <span>Das könnte dich auch noch interessieren:</span>
            </div>
        </div>
        <svg class="Rechteck_66">
            <rect id="Rechteck_66" rx="0" ry="0" x="0" y="0" width="1919" height="1257">
            </rect>
        </svg>
        <div id="Home______Konto______Privatkon_u">
            <span>Home      Konto      Privatkonto      Bank Austria Go Green Konto</span>
        </div>
        <svg class="Pfad_945_v" viewBox="637.933 5265 11.209 6">
            <path id="Pfad_945_v" d="M 637.93310546875 5265.00048828125 L 643.3165893554688 5271.00048828125 L 649.1424560546875 5265.00048828125">
            </path>
        </svg>
        <svg class="Pfad_946_w" viewBox="637.933 5265 11.209 6">
            <path id="Pfad_946_w" d="M 637.93310546875 5265.00048828125 L 643.3165893554688 5271.00048828125 L 649.1424560546875 5265.00048828125">
            </path>
        </svg>
        <svg class="Pfad_949" viewBox="637.933 5265 11.209 6">
            <path id="Pfad_949" d="M 637.93310546875 5265.00048828125 L 643.3165893554688 5271.00048828125 L 649.1424560546875 5265.00048828125">
            </path>
        </svg>
        <svg class="Pfad_947_y" viewBox="637.933 5265 11.209 6">
            <path id="Pfad_947_y" d="M 637.93310546875 5265.00048828125 L 643.3165893554688 5271.00048828125 L 649.1424560546875 5265.00048828125">
            </path>
        </svg>
        <svg class="Rechteck_23_z">
            <rect id="Rechteck_23_z" rx="0" ry="0" x="0" y="0" width="492" height="582">
            </rect>
        </svg>
        <div id="Stand_7122021_">
            <span>Stand: 7.12.2021</span>
        </div>
        <img id="bank-austria-ag-vector-logo-40_" src="img/bank-austria-ag-vector-logo-40_.png" srcset="img/bank-austria-ag-vector-logo-40_.png 1x, img/bank-austria-ag-vector-logo-40_@2x.png 2x">

        <div id="Bank_Austria__Go_Green_Konto__">
            <span>Bank Austria – Go Green Konto </span>
        </div>
        <div id="Kosten">
            <span>Kosten</span>
        </div>
        <div id="bot-Bewertung">
            <span>bot-Bewertung</span>
        </div>
        <div id="Kontodetails">
            <span>Kontodetails</span>
        </div>
        <div onclick="application.goToTargetView(event)" id="Zurck_zur_bersicht">
            <span>Zurück zur Übersicht</span>
        </div>
        <div id="Gruppe_268">
            <img id="Gruppe_248_" src="img/Gruppe_248_.png" srcset="img/Gruppe_248_.png 1x, img/Gruppe_248_@2x.png 2x">

            </svg>
            <img id="Gruppe_248_a" src="img/Gruppe_248_a.png" srcset="img/Gruppe_248_a.png 1x, img/Gruppe_248_a@2x.png 2x">

            </svg>
            <img id="Gruppe_248_b" src="img/Gruppe_248_b.png" srcset="img/Gruppe_248_b.png 1x, img/Gruppe_248_b@2x.png 2x">

            </svg>
            <img id="Gruppe_248_c" src="img/Gruppe_248_c.png" srcset="img/Gruppe_248_c.png 1x, img/Gruppe_248_c@2x.png 2x">

            </svg>
            <img id="Gruppe_248_d" src="img/Gruppe_248_d.png" srcset="img/Gruppe_248_d.png 1x, img/Gruppe_248_d@2x.png 2x">

            </svg>
        </div>
        <div id="KontofhrungsgebhrJahr">
            <span>Kontoführungsgebühr/Jahr:</span>
        </div>
        <div id="jhrliche_Servicegebhr">
            <span>jährliche Servicegebühr:</span>
        </div>
        <div id="zu_unserer_Bot-Methodik">
            <span>zu unserer </span><span style="color:rgba(3,49,108,1);">Bot-Methodik</span>
        </div>
        <div id="auf_bestimmte_offlinemanuelle_">
            <span>auf bestimmte offline/manuelle Transaktionen <br />(z.B. Bargeldbehebung)</span>
        </div>
        <div id="erstes_Jahr_fr_Neukunden_koste">
            <span>*erstes Jahr für Neukunden kostenlos (xxx.2021) <br />Vergleich Kosten konventionelles Konto: € 25,56</span>
        </div>
        <div id="n_3576">
            <span>€ 35,76*</span>
        </div>
        ...
        <div id="Nachhaltige_Gtesiegel">
            <span>Nachhaltige Gütesiegel</span>
        </div>
        <div id="Hard_Facts">
            <span>Hard Facts</span>
        </div>
        <div id="Good_to_know_">
            <span>Good to know </span>
        </div>
        <div id="Gruppe_257">
            <svg class="Pfad_943_o" viewBox="637.933 5252.46 19.046 13.301">
                <path id="Pfad_943_o" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
                </path>
            </svg>
            <div id="Kontoerffnung_online_mittels_V">
                <span>Kontoeröffnung online mittels Videolegitimierung</span>
            </div>
        </div>
        <div id="Gruppe_263">
            <div id="Erstes_Jahr_fr_Neukunden_koste">
                <span>Erstes Jahr für Neukunden kostenlos (Neukunden, bis 31.10.2021)</span>
            </div>
        </div>
        <div id="Gruppe_265">
            <div id="Mehrere_Nachhaltigkeits-Auszei">
                <span>Mehrere Nachhaltigkeits-Auszeichnungen (aus Banksicht)</span>
            </div>
        </div>
        <div id="Gruppe_264">
            <div id="CashBack_Programm_bei_jedem_Ei">
                <span>CashBack Programm bei jedem Einkauf bei GoGreen Partner mit GoGreen BankCard getätigtem Einkauf </span>
            </div>
        </div>
        <div id="Gruppe_266">
            <div id="Hhere_Kontogebhren_als_beim_ko">
                <span>Höhere Kontogebühren als beim konventionellen Online Konto</span>
            </div>
        </div>
        <div id="Gruppe_259">
            <svg class="Pfad_943_" viewBox="637.933 5252.46 19.046 13.301">
                <path id="Pfad_943_" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
                </path>
            </svg>
            <div id="alle_Online-Zahlungen_kostenlo">
                <span>alle Online-Zahlungen kostenlos vs. Transaktionen</span>
            </div>
        </div>
        <div id="Gruppe_260">
            <svg class="Pfad_943_baa" viewBox="637.933 5252.46 19.046 13.301">
                <path id="Pfad_943_baa" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
                </path>
            </svg>
            <div id="BankCard_Debitkarte__mit_CC_Fu">
                <span>BankCard (Debitkarte) – mit CC Funktion</span>
            </div>
        </div>
        <div id="Gruppe_261">
            <div id="Mobile_Banking_App_">
                <span>Mobile Banking App </span>
            </div>
        </div>
        <svg class="Pfad_943_bab" viewBox="637.933 5252.46 19.046 13.301">
            <path id="Pfad_943_bab" d="M 637.93310546875 5259.1435546875 L 643.870849609375 5265.76123046875 L 656.9795532226562 5252.46044921875">
            </path>
        </svg>
        <div id="kostenloser_Kontowechselservic_">
            <span>kostenloser Kontowechselservice</span>
        </div>
        <div id="Gruppe_251_baa">
            <div id="Gruppe_250_baa">
                <img id="Gruppe_249_baa" src="img/Gruppe_249_baa.png" srcset="img/Gruppe_249_baa.png 1x, img/Gruppe_249_baa@2x.png 2x">

                </svg>
            </div>
        </div>
        <div id="n_Affiliate_Link_Kostet_dich_n">
            <span>(*) Affiliate Link:</span><span style="font-style:normal;font-weight:normal;"> Kostet dich nichts, aber wenn du dich letztendlich für das Produkt begeisterst und Konto wechselst, bekommen wir eine Provision und können dadurch birds of trust weiterentwickeln. </span>
        </div>
        <img id="Umweltzeichen_bac" src="img/Umweltzeichen_bac.png" srcset="img/Umweltzeichen_bac.png 1x, img/Umweltzeichen_bac@2x.png 2x">

        <img id="fng_bad" src="img/fng_bad.png" srcset="img/fng_bad.png 1x, img/fng_bad@2x.png 2x">

        <div id="Gruppe_269">
            <div id="Wichtige_Dokumente">
                <span>Wichtige Dokumente</span>
            </div>
            <div id="Wiederholungsraster_8">
                <div id="Group_bah" class="">
                    <svg class="Linie_47" viewBox="0 0 262 1">
                        <path id="Linie_47" d="M 0 0 L 262 0">
                        </path>
                    </svg>
                    <div id="Produktinfoblatt">
                        <span>Produktinfoblatt</span>
                    </div>
                    <div id="n_8_kB">
                        <span>18 kB</span>
                    </div>
                    <div id="Pfeil-re_bal" class="Pfeil_re">
                        <div id="Gruppe_267">
                            <svg class="Pfad_104" viewBox="26.528 0.75 3.894 8.137">
                                <path id="Pfad_104" d="M 26.52809906005859 0.7500019073486328 L 30.42162322998047 4.818154335021973 L 26.52809906005859 8.886676788330078">
                                </path>
                            </svg>
                            <svg class="Linie_3" viewBox="0 0 12.39 1.5">
                                <path id="Linie_3" d="M 0 0 L 12.38960742950439 0">
                                </path>
                            </svg>
                        </div>
                    </div>
                </div>
                <div id="Group_bap" class="">
                    <svg class="Linie_47_baq" viewBox="0 0 262 1">
                        <path id="Linie_47_baq" d="M 0 0 L 262 0">
                        </path>
                    </svg>
                    <div id="Preisinfo">
                        <span>Preisinfo</span>
                    ...
                    <div id="Pfeil-re_bat" class="Pfeil_re">
                        <div id="Gruppe_267_bau">
                            <svg class="Pfad_104_bav" viewBox="26.528 0.75 3.894 8.137">
                                <path id="Pfad_104_bav" d="M 26.52809906005859 0.7500019073486328 L 30.42162322998047 4.818154335021973 L 26.52809906005859 8.886676788330078">
                                </path>
                            </svg>
                            <svg class="Linie_3_baw" viewBox="0 0 12.39 1.5">
                                <path id="Linie_3_baw" d="M 0 0 L 12.38960742950439 0">
                                </path>
                            </svg>
                        </div>
                    </div>
        ...
        <svg class="Rechteck_60">
            <rect id="Rechteck_60" rx="0" ry="0" x="0" y="0" width="5" height="5">
            </rect>
        </svg>
        <svg class="Rechteck_61">
            <rect id="Rechteck_61" rx="0" ry="0" x="0" y="0" width="5" height="5">
            </rect>
        </svg>
        <svg class="Rechteck_62">
            <rect id="Rechteck_62" rx="0" ry="0" x="0" y="0" width="5" height="5">
            </rect>
        </svg>
        <svg class="Rechteck_63">
            <rect id="Rechteck_63" rx="0" ry="0" x="0" y="0" width="5" height="5">
            </rect>
        </svg>
        <div id="Button_ba">
            <svg class="Rechteck_7_ba">
                <rect id="Rechteck_7_ba" rx="0" ry="0" x="0" y="0" width="173" height="54">
                </rect>
            </svg>
            <div id="Zum_Anbieter">
        ...
        <svg class="Linie_44_ba" viewBox="0 0 2 48">
            <path id="Linie_44_ba" d="M 0 0 L 0 48">
            </path>
        </svg>
        <div id="Mchtest_auch_du_dein_Feedback_">
            <span>Möchtest auch du dein Feedback mit unserer Community teilen?</span>
        </div>
        <div id="Gruppe_283">
            <div id="Bewertung_unserer_Community">
                <span>Bewertung unserer Community:</span>
            </div>
            <div id="Ich_war_wirklich_sehr_berrasch">
                <span>Ich war wirklich sehr überrascht über die schnelle Abwicklung des Kontowechsels. Auch super finde ich, dass die Bank Austria mich regelmäßig informiert. </span>
            </div>
            <div id="Bin_begeistert_Bank_Austria_ko">
                <span>Bin begeistert, Bank Austria konnte mir alle möglichen Fragen sehr rasch beantworten und agiert sehr transparent. </span>
            </div>
            <div id="n_42022__Marisa_S">
                <span>5.4.2022 – Marisa S.</span>
            </div>
            <div id="n_122021__Sophie_B">
                <span>2.12.2021 – Sophie B.</span>
            </div>
            <div id="Bee_Green_Konto">
                <span>Be(e) Green Konto</span>
            </div>
            <div id="Bee_Green_Konto_bbd">
                <span>Be(e) Green Konto</span>
            </div>
            <div id="Gruppe_271">
                <div id="Gruppe_272">
                    <svg class="Pfad_948" viewBox="0 0 21.029 20">
                        <path id="Pfad_948" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_278">
                <div id="Gruppe_272_bbi">
                    <svg class="Pfad_948_bbj" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bbj" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_275">
                <div id="Gruppe_272_bbl">
                    <svg class="Pfad_948_bbm" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bbm" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_279">
                <div id="Gruppe_272_bbo">
                    <svg class="Pfad_948_bbp" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bbp" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_273">
                <div id="Gruppe_272_bbr">
                    <svg class="Pfad_948_bbs" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bbs" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_280">
                <div id="Gruppe_272_bbu">
                    <svg class="Pfad_948_bbv" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bbv" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_274">
                <div id="Gruppe_272_bbx">
                    <svg class="Pfad_948_bby" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bby" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_281">
                <div id="Gruppe_272_bb">
                    <svg class="Pfad_948_bb" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bb" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_276">
                <div id="Gruppe_272_bca">
                    <svg class="Pfad_948_bca" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bca" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Gruppe_282">
                <div id="Gruppe_272_bcb">
                    <svg class="Pfad_948_bcb" viewBox="0 0 21.029 20">
                        <path id="Pfad_948_bcb" d="M 10.51427936553955 0 L 7.265250682830811 6.583675384521484 L 0 7.639272212982178 L 5.256576061248779 12.76403999328613 L 4.016222953796387 20 L 10.51427936553955 16.5831127166748 L 17.0123348236084 20 L 15.77198219299316 12.76403999328613 L 21.0285587310791 7.639272212982178 L 13.76330757141113 6.583675384521484 L 10.51427936553955 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div onclick="application.goToTargetView(event)" id="Button_bb" class="Button">
                <svg class="Rechteck_7_bb">
                    <rect id="Rechteck_7_bb" rx="0" ry="0" x="0" y="0" width="181" height="40">
                    </rect>
                </svg>
                <div id="Weitere_Kommentare">
                    <span>Weitere Kommentare</span>
                </div>
            </div>
        </div>
        <div onclick="application.goToTargetView(event)" id="Button_bcb" class="Button">
            <svg class="Rechteck_7_bcc">
                <rect id="Rechteck_7_bcc" rx="0" ry="0" x="0" y="0" width="140" height="40">
                </rect>
            </svg>
            <div id="Feedback_geben">
                <span>Feedback geben</span>
            </div>
        </div>
        <svg class="Linie_48" viewBox="0 0 461 1">
            <path id="Linie_48" d="M 0 0 L 461 0">
            </path>
        </svg>
        <svg class="Linie_49" viewBox="0 0 461 1">
            <path id="Linie_49" d="M 0 0 L 461 0">
            </path>
        </svg>
        <div id="Footer_bcg" class="Footer">
            <div onclick="application.goToTargetView(event)" id="AGB_bch">
                <span>AGB</span>
            </div>
            <div onclick="application.goToTargetView(event)" id="Datenschutz_bci">
                <span>Datenschutz</span>
            </div>
            <div onclick="application.goToTargetView(event)" id="Newsletteranmeldung_bcj">
                <span>Newsletteranmeldung</span>
            </div>
            <div onclick="application.goToTargetView(event)" id="Impressum_bck">
                <span>Impressum</span>
            </div>
            <div id="Alle_Texte_sowie_die_Hinweise__bcl">
        ...
        <div id="Follow_Us_-_Blog_bdk" class="Follow_Us___Blog">
            <div id="Gruppe_315_bdl">
                ...
                <div id="Lorem_ipsum_dolor_sit_amet_con_bd">
            ...
            <div id="Gruppe_316_bd">
                <svg class="Rechteck_45_bd">
                    <rect id="Rechteck_45_bd" rx="0" ry="0" x="0" y="0" width="298" height="290">
                    </rect>
                </svg>
                <img id="Bild1_bd" src="img/Bild1_bd.png" srcset="img/Bild1_bd.png 1x, img/Bild1_bd@2x.png 2x">

                <div id="Gruppe_216_bd">
                    <div id="birdsoftrust_3_April_bd">
                        <span>birdsoftrust</span><br /><span style="font-style:normal;font-weight:lighter;">3. April</span>
                    </div>
                    <div id="Gruppe_214_bd">
                        <div id="Gruppe_213_bea">
                            <div id="n__beb">
                                <span>4</span>
                            </div>
                            <img id="Bild_1_bec" src="img/Bild_1_bec.png" srcset="img/Bild_1_bec.png 1x, img/Bild_1_bec@2x.png 2x">

                            <img id="Bild_2_bed" src="img/Bild_2_bed.png" srcset="img/Bild_2_bed.png 1x, img/Bild_2_bed@2x.png 2x">

                            <svg class="Rechteck_44_bee">
                                <rect id="Rechteck_44_bee" rx="0" ry="0" x="0" y="0" width="22" height="23">
                                </rect>
                            </svg>
                            <div id="n_5_bef">
                                <span>25</span>
                    ...
                    <div id="Gruppe_215_beg">
                        <svg class="Ellipse_12_beh">
                            <ellipse id="Ellipse_12_beh" rx="26.127899169921875" ry="26.127899169921875" cx="26.127899169921875" cy="26.127899169921875">
                            </ellipse>
                        </svg>
                        <div id="Ebene_2_bei">
                            <div id="Ebene_1_bej">
                                <div id="Gruppe_113_bek">
                                    <svg class="Pfad_113_bel" viewBox="144.891 0 52.817 12.542">
                                        <path id="Pfad_113_bel" d="M 168.2411804199219 12.54227447509766 C 167.8211364746094 12.54227447509766 167.4266357421875 12.3341703414917 167.15771484375 11.95836162567139 C 166.6829376220703 11.29495048522949 166.7095184326172 10.318115234375 167.2308959960938 9.343507766723633 C 167.6418609619141 8.567933082580566 168.2290496826172 7.772597789764404 168.970703125 6.988410949707031 C 168.8742065429688 6.814169883728027 168.7678527832031 6.639458656311035 168.6504058837891 6.465274810791016 C 167.0174713134766 4.040791511535645 163.7938079833984 2.341738939285278 160.2377166748047 2.030543327331543 C 152.6326141357422 1.368636965751648 145.2698059082031 6.241406917572021 145.1968231201172 6.28901195526123 L 144.8907470703125 5.835519790649414 C 144.9672241210938 5.785888195037842 152.4799346923828 0.7994511127471924 160.2858581542969 1.48614513874054 C 164.0022125244141 1.811497688293457 167.3803100585938 3.601196527481079 169.1038818359375 6.161131858825684 C 169.1983337402344 6.300160884857178 169.28515625 6.440433979034424 169.3674774169922 6.5827317237854 C 172.5817108154297 3.421666145324707 178.2508239746094 0.5325412154197693 184.9274597167969 0.06489218026399612 C 196.3937683105469 -0.7304430603981018 197.6927490234375 6.050986766815186 197.7074279785156 6.120112419128418 L 197.1681365966797 6.212573051452637 C 197.1220245361328 5.953028678894043 195.9157104492188 -0.1630210280418396 184.9649200439453 0.6107933521270752 C 178.3308563232422 1.074916005134583 172.7280731201172 3.96051025390625 169.6323394775391 7.082324504852295 C 170.2266082763672 8.333178520202637 170.3578186035156 9.619498252868652 169.9987487792969 10.79183387756348 C 169.6964416503906 11.78214931488037 169.1307525634766 12.41393089294434 168.4493560791016 12.52584171295166 C 168.3797149658203 12.53849315643311 168.3085784912109 12.54227924346924 168.2411804199219 12.54227924346924 L 168.2411804199219 12.54227924346924 Z M 169.2264404296875 7.509474277496338 C 168.5878448486328 8.208353996276855 168.0776214599609 8.913043022155762 167.7110137939453 9.599990844726562 C 167.2914276123047 10.38796710968018 167.25244140625 11.15062999725342 167.600830078125 11.64011383056641 C 167.7945404052734 11.90873432159424 168.0738372802734 12.03334903717041 168.3622283935547 11.98698139190674 C 168.828369140625 11.91075134277344 169.2355499267578 11.41598606109619 169.4776000976562 10.63133430480957 C 169.7784271240234 9.65340518951416 169.6857757568359 8.573217391967773 169.2264251708984 7.509475708007812 L 169.2264251708984 7.509475708007812 Z">
                                        </path>
                                    </svg>
                                </div>
                            </div>
                ...
                <div id="Lorem_ipsum_dolor_sit_amet_con_bem">
                    <span>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</span>
                </div>
            </div>
            <div id="birdsoftrust_ben">
                <span>@birdsoftrust</span>
            </div>
            <div id="Jetzt_birds_of_trust_auf_Insta_beo">
                <span>Jetzt birds of trust auf Instagram folgen</span>
            </div>
            <div id="Follow_Us_bep">
                <span>Follow Us</span>
            </div>
            <div id="Du_willst_noch__mehr_wissen_beq">
                <span>Du willst noch <br />mehr wissen?</span>
            </div>
            <div id="Dann_werde_Teil_unserer_birds__ber">
            ...
            <div id="Gruppe_233_bes">
                <div id="Gruppe_166_bet">
                    <img id="Gruppe_165_beu" src="img/Gruppe_165_beu.png" srcset="img/Gruppe_165_beu.png 1x, img/Gruppe_165_beu@2x.png 2x">

                    </svg>
                </div>
                <div id="Gruppe_157_bev">
                    <img id="Gruppe_156_bew" src="img/Gruppe_156_bew.png" srcset="img/Gruppe_156_bew.png 1x, img/Gruppe_156_bew@2x.png 2x">

                    </svg>
                </div>
                <div id="Gruppe_160_bex">
                    <img id="Gruppe_159_bey" src="img/Gruppe_159_bey.png" srcset="img/Gruppe_159_bey.png 1x, img/Gruppe_159_bey@2x.png 2x">
        ...
        <div id="Gruppe_290">
            <svg class="Linie_45" viewBox="0 0 3 20">
                <path id="Linie_45" d="M 0 0 L 0 20">
                </path>
            </svg>
            <svg class="Linie_46" viewBox="0 0 20 3">
                <path id="Linie_46" d="M 20 0 L 0 0">
                </path>
            </svg>
        </div>
        <!--div> id="Musteransicht_be">
        <span>Musteransicht</span>
    </div>
    <div id="Gruppe_305_be">
        <div id="Musteransicht_bfa">
            <span>Musteransicht</span>
        </div>
        <div id="Musteransicht_bfb">
            <span>Musteransicht</span>
        </div>
        <div id="Musteransicht_bfc">
            <span>Musteransicht</span>
        </div>
    </div-->
        <div id="Kontaktflappe_be" class="Kontaktflappe">
            <svg class="Rechteck_20_be">
                <rect id="Rechteck_20_be" rx="0" ry="0" x="0" y="0" width="55" height="223">
                </rect>
            </svg>
            <div id="Gruppe_166_be">
                <img id="Gruppe_165_bfa" src="img/Gruppe_165_bfa.png" srcset="img/Gruppe_165_bfa.png 1x, img/Gruppe_165_bfa@2x.png 2x">

                </svg>
            </div>
            <div id="Ebene_2_bfb">
                <div id="Ebene_1_bfc">
                    <div id="Gruppe_170_bfd">
                        <div id="Gruppe_169_bfe">
                            <svg class="Linie_12_bff" viewBox="0 0 17.416 3">
                                <path id="Linie_12_bff" d="M 17.41588973999023 0 L 0 0">
                                </path>
                            </svg>
                            <svg class="Linie_14_bfg" viewBox="0 0 17.416 3">
                                <path id="Linie_14_bfg" d="M 17.41588973999023 0 L 0 0">
                                </path>
                            </svg>
                        </div>
                        <svg class="Pfad_887_bfh" viewBox="0.893 0.893 31.373 30">
                            <path id="Pfad_887_bfh" d="M 29.75608444213867 0.8928599953651428 L 3.402654886245728 0.8928599953651428 C 2.022186279296875 0.8928599953651428 0.8928599953651428 2.022302627563477 0.8928599953651428 3.402654886245728 L 0.8928599953651428 20.7850170135498 C 0.8928599953651428 22.16548728942871 2.022186279296875 23.2948112487793 3.402654886245728 23.2948112487793 L 9.333661079406738 23.2948112487793 L 9.333661079406738 29.91862487792969 C 9.333661079406738 30.78478622436523 10.3809871673584 31.21864891052246 10.99347591400146 30.60615921020508 L 18.30483245849609 23.29480171203613 L 29.756103515625 23.29480171203613 C 31.13657379150391 23.29480171203613 32.26596450805664 22.16547584533691 32.26596450805664 20.78500747680664 L 32.26596450805664 3.402654886245728 C 32.26596450805664 2.022313117980957 31.13657379150391 0.892859935760498 29.756103515625 0.892859935760498 Z">
                            </path>
                        </svg>
                    </div>
                </div>
            </div>
            <div id="Gruppe_157_bfi">
                <img id="Gruppe_156_bfj" src="img/Gruppe_156_bfj.png" srcset="img/Gruppe_156_bfj.png 1x, img/Gruppe_156_bfj@2x.png 2x">

                </svg>
            </div>
            <img id="Gruppe_159_bfk" src="img/Gruppe_159_bfk.png" srcset="img/Gruppe_159_bfk.png 1x, img/Gruppe_159_bfk@2x.png 2x">

            </svg>
        </div>
        <div id="Men_bfl" class="Men_">
            <svg class="Rechteck_73_bfm">
                <rect id="Rechteck_73_bfm" rx="0" ry="0" x="0" y="0" width="1920" height="68">
                </rect>
            </svg>
            <div id="Men_bfn">
                <svg class="Pfad_904_bfo" viewBox="0 0 1920 50">
                    <path id="Pfad_904_bfo" d="M 0 0 L 1920 0 L 1920 50 L 0 50 L 0 0 Z">
                    </path>
                </svg>
                ...
                <div id="Ebene_2_bga">
                    <div id="Ebene_1_bga">
                        <div id="Gruppe_118_bf">
                            <svg class="Pfad_143_bf" viewBox="18.839 18.809 9.256 9.256">
                            ...
                            <svg class="Pfad_144_bf" viewBox="0.893 0.893 20.477 20.477">
                                <path id="Pfad_144_bf" d="M 21.3698616027832 11.1312894821167 C 21.3698616027832 16.78590965270996 16.78593635559082 21.3698616027832 11.13128852844238 21.3698616027832 C 5.476641654968262 21.3698616027832 0.8928599953651428 16.78590965270996 0.8928599953651428 11.1312894821167 C 0.8928599953651428 5.476668834686279 5.476829528808594 0.8928599953651428 11.1312894821167 0.8928599953651428 C 16.7857494354248 0.8928599953651428 21.3698616027832 5.47663402557373 21.3698616027832 11.13125514984131 Z">
                                </path>
                            </svg>
                        </div>
                    </div>
