...
<title>News – 1</title>
	<link rel="stylesheet" href="css/News__1.css" id="applicationStylesheet">
	<script id="applicationScript" src="js/News__1.js"></script>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">

	<!--style-- id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: News – 1;
		--web-view-id: News__1;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: News__1;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Musteransicht_ss {
		opacity: 0.06;
		transform: translate(-275.66px, -1016.246px) matrix(1,0,0,1,286.5772,1129.5233) rotate(-12deg);
	...
	#Musteransicht_st {
		opacity: 0.06;
		transform: translate(-275.66px, -1016.246px) matrix(1,0,0,1,286.5772,2126.5232) rotate(-12deg);
		transform-origin: center;
		left: 0px;
		top: 0px;
		position: absolute;
	...
	#Musteransicht_su {
		opacity: 0.06;
		transform: translate(-275.66px, -1016.246px) matrix(1,0,0,1,286.5772,3192.2698) rotate(-12deg);
		transform-origin: center;
		left: 0px;
		top: 0px;
		position: absolute;
	...
	#Bei_der_Anwendung_von_Labels_w {
		left: 483px;
		top: 2402.997px;
		position: absolute;
		overflow: visible;
	...
	#Bleiben_wir_wachsam_aber_bertr {
		left: 483px;
		top: 2763.997px;
		position: absolute;
		overflow: visible;
	...
	#Alle_Texte_sowie_die_Hinweise__s {
		left: 658px;
		top: 67.278px;
		position: absolute;
		overflow: visible;
	...
	#Greenwashing__ein_Kind_unserer_t {
		left: 483px;
		top: 1000px;
		position: absolute;
		overflow: visible;
	...
	#Pfeil-re_uh {
		transform: matrix(1,0,0,1,483,3184.9966) rotate(180deg);
		transform-origin: center;
		position: absolute;
		width: 24px;
		height: 15px;
	...
	#Wir_leben_in_einer_Zeit_in_der {
		left: 481px;
		top: 1280.997px;
		position: absolute;
		overflow: visible;
	...
	#Nachhaltige_Finanzprodukte_ern {
		left: 481px;
		top: 1793.997px;
		position: absolute;
		overflow: visible;
	...
	#Worauf_sollest_du_achten_um_hi {
		left: 481px;
		top: 2050.997px;
		position: absolute;
		overflow: visible;
	...
	#Eine_Bank_ist_nicht_schon_per_ {
		left: 483px;
		top: 2106.997px;
		position: absolute;
		overflow: visible;
	...
	#Unter_nachhaltigen_Finanzprodu {
		left: 483px;
		top: 1849.997px;
		position: absolute;
		overflow: visible;
	...
	#httpsthesustainablepeoplecomgr {
		left: 481px;
		top: 3037.997px;
		position: absolute;
		overflow: visible;
...
<body>
<div id="News__1">
	<!--div id="Gruppe_305_sr">
		<div id="Musteransicht_ss">
			<span>Musteransicht</span>
		</div>
		<div id="Musteransicht_st">
			<span>Musteransicht</span>
		</div>
		<div id="Musteransicht_su">
			<span>Musteransicht</span>
		</div>
	</div-->
	<div id="Bei_der_Anwendung_von_Labels_w">
		<span>Bei der Anwendung von Labels wird häufig das Best-in-class-Verfahren verwendet. Das bedeutet, dass man aus jeder Branche (z.B. Automobilbranche) in das jeweils beste Unternehmen investiert. Häufig findet sich dies in Kombination mit den Ausschlusskriterien: Hier werden besonders „toxische“ Branchen ausgeschlossen wie z.B. Waffen, Gentechnik, Atomkraft, Glücksspiel. Was will ich damit sagen? Auch in einem grünen Fonds können „Spurenelemente“ von VW & Co drinnen sein. <br/><br/>Seit Anfang des Jahres müssen die Finanzanbieter ihre Fonds in hell- und dunkelgrüne Produkte einteilen und den Kunden auf der Website kommunizieren (Für die Genaueren unter uns: Es geht um die Offenlegungs-VO, die seit März 2021 in Kraft ist). Also ein Fonds nach Art. 8 gilt als hellgrün, ein Fonds nach Art.9 gilt als dunkelgrün. Auch das ist ein guter Indikator, um ein seriöses Produkt zu finden. </span>
	</div>
	<div id="Bleiben_wir_wachsam_aber_bertr">
		<span>Bleiben wir wachsam, aber übertreiben wir es nicht. Ein (kleiner) Schritt in die richtige Richtung ist besser, als kein Schritt. Lassen wir uns die Bemühungen vieler seriöser Unternehmen nicht durch die unerfreuliche Grünfärberei einzelner Unternehmen vermiesen. Und nicht als Ausrede benutzen, warum wir nichts tun. Wie immer im Leben gibt es eine Bandbreite für unsere Entscheidung: Hellgrün ist für den Anfang gut. Aber bleiben wir kritisch, dann wird aus hellgrün sukzessive dunkelgrün. Mission erfüllt. <br/><br/>Was meint ihr dazu? Reden wir drüber! Bitte schreibt mir unter </span><span style="color:rgba(3,49,108,1);">heidrun.kopp@inafina.org</span>
	</div>
	<img id="iStock-1349465204_sx" src="img/iStock-1349465204_sx.png" srcset="img/iStock-1349465204_sx.png 1x, img/iStock-1349465204_sx@2x.png 2x">
		
	<div id="Footer_sy" class="Footer">
		<div onclick="application.goToTargetView(event)" id="AGB_sz">
			<span>AGB</span>
		</div>
		<div onclick="application.goToTargetView(event)" id="Datenschutz_s">
			<span>Datenschutz</span>
		</div>
		<div onclick="application.goToTargetView(event)" id="Newsletteranmeldung_s">
			<span>Newsletteranmeldung</span>
		</div>
		<div onclick="application.goToTargetView(event)" id="Impressum_s">
			<span>Impressum</span>
		</div>
		<div id="Alle_Texte_sowie_die_Hinweise__s">
		...
		<svg class="Pfad_903_tz" viewBox="2645 7050.722 1275.998 1">
			<path id="Pfad_903_tz" d="M 2645 7050.7216796875 L 3920.998046875 7050.7216796875">
			</path>
		</svg>
		<div id="Gruppe_289_t">
			<svg class="Pfad_950_t" viewBox="-90 -52.727 23.547 22.5">
				<path id="Pfad_950_t" d="M -66.4534912109375 -38.93214416503906 L -66.4534912109375 -30.22700500488281 L -71.50028991699219 -30.22700500488281 L -71.50028991699219 -38.34923934936523 C -71.50028991699219 -40.38967514038086 -72.23023986816406 -41.78205871582031 -74.05718231201172 -41.78205871582031 C -75.45191955566406 -41.78205871582031 -76.28153991699219 -40.84334182739258 -76.64677429199219 -39.93575286865234 C -76.77993774414062 -39.61133193969727 -76.81422424316406 -39.15950012207031 -76.81422424316406 -38.7053108215332 L -76.81422424316406 -30.22700500488281 L -81.86233520507812 -30.22700500488281 C -81.86233520507812 -30.22700500488281 -81.79430389404297 -43.98339080810547 -81.86233520507812 -45.40874099731445 L -76.81422424316406 -45.40874099731445 L -76.81422424316406 -43.25685882568359 C -76.82440185546875 -43.24063491821289 -76.83749389648438 -43.22336578369141 -76.84718322753906 -43.20767211914062 L -76.81422424316406 -43.20767211914062 L -76.81422424316406 -43.25685882568359 C -76.14366149902344 -44.28975677490234 -74.9459228515625 -45.76534271240234 -72.26503753662109 -45.76534271240234 C -68.94338989257812 -45.76534271240234 -66.4534912109375 -43.59540557861328 -66.4534912109375 -38.93214416503906 M -87.14329528808594 -52.72700500488281 C -88.87028503417969 -52.72700500488281 -90 -51.59414672851562 -90 -50.10443496704102 C -90 -48.64717102050781 -88.90299987792969 -47.48005294799805 -87.21025085449219 -47.48005294799805 L -87.176513671875 -47.48005294799805 C -85.416015625 -47.48005294799805 -84.32110595703125 -48.64717102050781 -84.32110595703125 -50.10443496704102 C -84.35432434082031 -51.59414672851562 -85.416015625 -52.72700500488281 -87.14329528808594 -52.72700500488281 M -89.70016479492188 -30.22700500488281 L -84.65364074707031 -30.22700500488281 L -84.65364074707031 -45.40874099731445 L -89.70016479492188 -45.40874099731445 L -89.70016479492188 -30.22700500488281 Z">
				</path>
			</svg>
		</div>
	</div>
	<div id="Greenwashing__ein_Kind_unserer_t">
		<span>Greenwashing – ein Kind unserer Zeit oder nur miese Geschäftemacherei?</span>
	</div>
	<div id="n_3_Mai_2022_t">
		<span>13. Mai 2022</span>
	</div>
	<div id="von_Heidrun_Kopp">
		<span>von Heidrun Kopp</span>
	</div>
	<div id="Wir_leben_in_einer_Zeit_in_der">
		<span>Wir leben in einer Zeit, in der alles sehr nach außen gerichtet ist. Ob das einerseits die Nabelschau vieler Influencer:innen ist, oder die PR-Maschinerie von Unternehmen. Der Trend zeigt auf grün und nachhaltig. Somit will jedes Unternehmen auf der grünen Welle surfen. Das muss per se noch nicht unseriös sein. Wird es aber, wenn unzureichende oder falsche Informationen über Produkte kommuniziert werden oder das Verantwortungsbewusstsein eines Unternehmens hervorgehoben wird, ohne dass es dafür eine reale Grundlage gibt. <br/><br/>Diese „missverständliche“ Unternehmenskommunikation (also</span><span style="font-style:normal;font-weight:bold;"> „Greenwashing“</span><span>) gibt es in unterschiedlichen Formen: Positive Eigenschaften eines Produkts werden hervorgehoben, obwohl sie in der Gesamtbetrachtung irrelevant sind oder in einem insgesamt negativen Kontext stehen. Umweltschädigende Produkte werden durch schöne Bilder von grünen Wiesen, unberührter Natur und glücklichen Kindern auf „heile Welt“ getrimmt. Nicht selten kommt es auch vor, dass der Impact eines Produkts wesentlich positiver dargestellt wir, als er tatsächlich ist. Die Liste kreativer Möglichkeiten lässt sich beliebig lang fortsetzen….<br/><br/>Nicht immer passiert Greenwashing absichtlich. Mitunter liegt es an mangelnder Kenntnis der Materie oder aber geringer Sensibilität gegenüber dem Thema – der Grad ist schmal zwischen gut gemeinter Information und vorsätzlicher Falschmeldung. Das ist auch für Profis wie Umwelt-NGOs nicht immer ganz klar herauszufiltern. Also gilt: Hausverstand einsetzen und kritisch hinterfragen. Denn letztlich wollen wir doch alle das Gleiche: Wir wollen den Bemühungen für eine klimaneutrale Wirtschaft bzw. Zukunft eine Chance geben.  </span>
	</div>
	<div id="Nachhaltige_Finanzprodukte_ern">
		<span>Nachhaltige Finanzprodukte: ernstzunehmende Initiative oder gute PR?</span>
	</div>
	<div id="Worauf_sollest_du_achten_um_hi">
		<span>Worauf sollest du achten, um hier Greenwashing zu verhindern?</span>
	</div>
	<div id="Fazit">
		<span>Fazit</span>
	</div>
	<div id="Das_solltest_du_wissen_">
		<span>Das solltest du wissen: </span>
	</div>
	<div id="Eine_Bank_ist_nicht_schon_per_">
		<span>Eine Bank ist nicht schon per se „grün“, wenn sie ökologische Produkte wie Girokonten und Fonds anbieten. Also: Unterscheide zwischen Bank und Produkt. Auch eine Bank, die man auf den ersten Blick vielleicht nicht als übermäßig nachhaltig einstufen würde, kann ein seriöses, grünes Girokonto anbieten. <br/><br/>Bei Giro- und Sparkonten solltest du deshalb auf das Österreichische Umweltzeichen für nachhaltige Finanzprodukte (auch UZ49) achten. Dieses Label wird seit 2004 (!) vom Umwelt-/ Klimaministerium gemeinsam mit dem Verein für Konsumenteninformation (VKI) vergeben und durch externe Gutachter bestätigt. Das UZ49 wird auch für grüne (Investment)fonds vergeben, wobei es für diese Produkte noch zusätzliche Labels wie das Eurosif oder auch das FNG-Siegel gibt.  </span>
	</div>
	<div id="Unter_nachhaltigen_Finanzprodu">
		<span>Unter nachhaltigen Finanzprodukten – also z.B. Giro- und Sparkonten, Fonds und Versicherungen – versteht man solche, bei denen durch das Geld der Sparer:innen und Anleger:innen ökologische, soziale und/oder ethische Projekte finanziert werden. Nicht die Bank oder Versicherung entscheidet, welche Unternehmen oder Projekte finanziert werden, sondern du als Bank- oder Versicherungskund:in hast es in der Hand. Seit etlichen Monaten boomt diesbezüglich die Werbung: Von GoGreen (Bank Austria) bis zu be(e) green der Oberbank sagt uns die Werbung, wie grün die Banken bzw. deren Produkte sind. </span>
	</div>
	<div id="httpsthesustainablepeoplecomgr">
		<span></span><span style="color:rgba(3,49,108,1);">https://thesustainablepeople.com/greenwashing<br/>https://redenwiruebergeld.fma.gv.at/greenwashing</span>
	</div>
	<div id="Zurck">
		<span>Zurück</span>
	</div>
	...
	<div id="Pfeil-re_uf" class="Pfeil_re">
		<img id="Gruppe_37_ug" src="img/Gruppe_37_ug.png" srcset="img/Gruppe_37_ug.png 1x, img/Gruppe_37_ug@2x.png 2x">
			
		</svg>
	</div>
	<div id="Pfeil-re_uh" class="Pfeil_re">
		<img id="Gruppe_37_ui" src="img/Gruppe_37_ui.png" srcset="img/Gruppe_37_ui.png 1x, img/Gruppe_37_ui@2x.png 2x">
			
		</svg>
	</div>
	<div id="Zum_Weiterlesen_">
		<span>Zum Weiterlesen: </span>
	</div>
	<div id="Kontaktflappe_uk" class="Kontaktflappe">
		<svg class="Rechteck_20_ul">
			<rect id="Rechteck_20_ul" rx="0" ry="0" x="0" y="0" width="55" height="223">
			</rect>
		</svg>
		<div id="Gruppe_166_um">
			<img id="Gruppe_165_un" src="img/Gruppe_165_un.png" srcset="img/Gruppe_165_un.png 1x, img/Gruppe_165_un@2x.png 2x">
				
			</svg>
		</div>
		<div id="Ebene_2_uo">
			<div id="Ebene_1_up">
				<div id="Gruppe_170_uq">
					<div id="Gruppe_169_ur">
						<svg class="Linie_12_us" viewBox="0 0 17.416 3">
							<path id="Linie_12_us" d="M 17.41588973999023 0 L 0 0">
							</path>
						</svg>
						<svg class="Linie_14_ut" viewBox="0 0 17.416 3">
							<path id="Linie_14_ut" d="M 17.41588973999023 0 L 0 0">
							</path>
						</svg>
					</div>
					<svg class="Pfad_887_uu" viewBox="0.893 0.893 31.373 30">
						<path id="Pfad_887_uu" d="M 29.75608444213867 0.8928599953651428 L 3.402654886245728 0.8928599953651428 C 2.022186279296875 0.8928599953651428 0.8928599953651428 2.022302627563477 0.8928599953651428 3.402654886245728 L 0.8928599953651428 20.7850170135498 C 0.8928599953651428 22.16548728942871 2.022186279296875 23.2948112487793 3.402654886245728 23.2948112487793 L 9.333661079406738 23.2948112487793 L 9.333661079406738 29.91862487792969 C 9.333661079406738 30.78478622436523 10.3809871673584 31.21864891052246 10.99347591400146 30.60615921020508 L 18.30483245849609 23.29480171203613 L 29.756103515625 23.29480171203613 C 31.13657379150391 23.29480171203613 32.26596450805664 22.16547584533691 32.26596450805664 20.78500747680664 L 32.26596450805664 3.402654886245728 C 32.26596450805664 2.022313117980957 31.13657379150391 0.892859935760498 29.756103515625 0.892859935760498 Z">
						</path>
					</svg>
				</div>
			</div>
		</div>
		<div id="Gruppe_157_uv">
			<img id="Gruppe_156_uw" src="img/Gruppe_156_uw.png" srcset="img/Gruppe_156_uw.png 1x, img/Gruppe_156_uw@2x.png 2x">
				
			</svg>
		</div>
		<img id="Gruppe_159_ux" src="img/Gruppe_159_ux.png" srcset="img/Gruppe_159_ux.png 1x, img/Gruppe_159_ux@2x.png 2x">
			
		</svg>
	</div>
	<div id="Men_uy" class="Men_">
		<svg class="Rechteck_73_uz">
			<rect id="Rechteck_73_uz" rx="0" ry="0" x="0" y="0" width="1920" height="68">
			</rect>
		</svg>
		<div id="Men_u">
			<svg class="Pfad_904_u" viewBox="0 0 1920 50">
				<path id="Pfad_904_u" d="M 0 0 L 1920 0 L 1920 50 L 0 50 L 0 0 Z">
				</path>
			</svg>
			...
			<div onclick="application.goToTargetView(event)" id="Finanzieren_u">
				<span>Finanzieren</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="ber_Uns_u">
				<span>Über Uns</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Wissen__News_u">
				<span>Wissen & News</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Methodik_u">
				<span>Methodik</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="DE__EN_u">
				<span>DE </span><span style="color:rgba(112,112,112,1);">| EN</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="Partner_Werden_u">
				<span>Partner Werden</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="FAQ_va">
				<span>FAQ</span>
			</div>
			<svg class="Rechteck_5_vb">
				<rect id="Rechteck_5_vb" rx="0" ry="0" x="0" y="0" width="149" height="3">
				</rect>
			</svg>
			<div onclick="application.goToTargetView(event)" id="Login_vc">
			...
			<div id="Ebene_2_vi">
				<div id="Ebene_1_vj">
					<div id="Gruppe_118_vk">
						<svg class="Pfad_143_vl" viewBox="18.839 18.809 9.256 9.256">
							<path id="Pfad_143_vl" d="M 18.83860015869141 21.83567047119141 L 24.44058799743652 27.43770980834961 C 25.27626800537109 28.27423477172852 26.63207244873047 28.27423477172852 27.46650123596191 27.43770980834961 C 28.30387687683105 26.60331726074219 28.30387687683105 25.24673080444336 27.46650123596191 24.41273880004883 L 21.86441612243652 18.80940246582031">
							</path>
						</svg>
						<svg class="Pfad_144_vm" viewBox="0.893 0.893 20.477 20.477">
							<path id="Pfad_144_vm" d="M 21.3698616027832 11.1312894821167 C 21.3698616027832 16.78590965270996 16.78593635559082 21.3698616027832 11.13128852844238 21.3698616027832 C 5.476641654968262 21.3698616027832 0.8928599953651428 16.78590965270996 0.8928599953651428 11.1312894821167 C 0.8928599953651428 5.476668834686279 5.476829528808594 0.8928599953651428 11.1312894821167 0.8928599953651428 C 16.7857494354248 0.8928599953651428 21.3698616027832 5.47663402557373 21.3698616027832 11.13125514984131 Z">
							</path>
						</svg>
					</div>
				</div>
